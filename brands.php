...
<table class="data-table table table-bordered table-hover text-center table-responsive" id = "brands">
	<caption class="title">Different Types of Brands</caption>
<thead>
...
echo "<tr>				
        ...
        echo "<td>".$status."</td>
          <td>".$rows[$i]['typename']."</td>
					<td><a  class='btn btn-danger' href='brands.php?did=".$rows[$i]['id']."'>Delete</a> </td>
					<td><a  id = 'update' class='btn btn-info' href='brands.php?uid=".$rows[$i]['id']."'  data-toggle='modal' data-target='#myModals'>Update</a> </td>
				</tr>";
$i++;
}
?>
      ...
      <div class="modal-content">
       ...
       <form action="brands.php" method="POST">
        <div class="form-group">
              <label><span class="fa fa-building"></span>Name of Brand</label>
              <input type="text"  name="name" placeholder="Enter New Brand Name" required>
            </div>
            <div class="form-group">
              <label><span class="fa fa-building"></span>Status of the Brand</label>
              <input type="checkbox"  name="isActive" >
            </div>
             <div class="form-group">
              <label><span class="fa fa-building"></span>Type of the brand</label>
