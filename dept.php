...
if(isset($_GET['uid'])) 
                ...
                header("location:updateDept.php");
                exit();
						}		
...
<table class="data-table table table-bordered table-hover text-center table-responsive" id = "brands">
	<caption class="title">Different  Departments</caption>
<thead>
...
echo "<tr>				
        ...
        echo "<td>".$status."</td>
					<td><a  class='btn btn-danger' href='dept.php?did=".$rows[$i]['id']."'>Delete</a> </td>
					<td><a  id = 'update' class='btn btn-info' href='dept.php?uid=".$rows[$i]['id']."'  data-toggle='modal' data-target='#myModals'>Update</a> </td>
				</tr>";
$i++;
}
?>
      ...
      <div class="modal-content">
       ...
       <form action="dept.php" method="POST">
        <div class="form-group">
              <label><span class="fa fa-building"></span>Name of Department</label>
              <input type="text"  name="deptName" placeholder="Enter New Department Name" required>
            </div>
            <div class="form-group">
              <label><span class="fa fa-building"></span>Status of the Department</label>
